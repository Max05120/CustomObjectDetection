...
# IMAGE_PATH = '/home/max/Documents/data/label11.jpeg'
# Restore checkpoint
...
@tf.function
def detect_fn(image):util.get_configs_from_pipeline_file(PATH_TO_CFG)
model_config = configs['model']
detection_model = model_builder.build(model_config=model_config, is_training=False)
IMAGE_PATH = '/home/max/Documents/data/label1040.jpg'
# Restore checkpoint
# ckpt = tf.compat.v2.train.Checkpoint(model=detection_model)
# ckpt.restore(os.path.join(PATH_TO_CKPT, 'ckpt-6')).expect_partial()
